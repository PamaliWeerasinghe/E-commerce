        ...
        <div class="row">
            ...
            ?>  
                ...
                <div class="col-12 btn-toolbar justify-content-end">
                    ...
                    <a href="pdf.php" class="btn btn-danger me-2"><i class="bi bi-filetype-pdf"></i> Export as PDF</a>
                </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr style="height: 72px;">
                                        ...
                                        <td>
                                            <span class="fw-bold text-primary text-decoration-underline p-2">invoice id</span><br />
                                            <?php
                                ...
                                <tfoot>
                                   ...
                                   // }
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">Rs.<?php echo $_SESSION["p"]["price"]?> .00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="border-0"></td>
                                        <td class="fs-5 text-end fw-bold border-primary">Delivery Fee</td>
                                        <td class="text-end border-primary">Rs. <?php echo $_SESSION["p"]["delivery_fee_colombo"]?> .00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="border-0"></td>
                                        <td class="fs-5 text-end fw-bold border-primary text-primary">GRAND TOTAL</td>
                                        <td class="fs-5 text-end fw-bold border-primary text-primary">Rs.<?php echo $_SESSION["p"]["delivery_fee_colombo"]+$_SESSION["p"]["price"]?> .00</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
