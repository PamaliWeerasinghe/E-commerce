...
<div class=" container-fluid d-flex justify-content-center" style="background-image: url(resources/logos/blob.png);background-repeat: no-repeat;background-size:100%; background-position:500px 220px; background-color: rgb(242, 247, 252); padding-top:45px; padding-bottom:65px;padding-left:155px;padding-right:155px;" >
    <div class="container-fluid">
        <div class="row">
            ...
            $summary=Database::search("SELECT * FROM `summary` WHERE `product_id`='".$id."' AND `user_email`='".$email."' AND `qty`='".$search_data["qty"]."' AND `dateTime`='".$date."'");
            $summary_num=$summary->num_rows;
            if($summary_num==0){
                Database::iud("INSERT INTO `summary`(`product_id`,`user_email`,`qty`,`dateTime`) VALUES('".$id."','".$email."','".$search_data["qty"]."','".$date."')");
            }
                                ...
                                <tbody>
                                    <tr style="height: 72px;">
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="fw-bold text-primary fs-3 p-2"><?php echo $_SESSION["p"]["title"]?></span>
                                        </td>
                                        <td class="fw-bold fs-6 text-end pt-3 bg-secondary text-white">Rs.<?php echo $_SESSION["p"]["price"]?>  .00</td>
                                        <td class="fw-bold fs-6 text-end pt-3"><?php echo $search_data["qty"]?></td>
                                        <td class="fw-bold fs-6 text-end pt-3 bg-secondary text-white">Rs.<?php echo $_SESSION["p"]["price"]*$search_data["qty"]?> .00</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <?php
                                   ...
                                   // }
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">Rs.<?php echo $_SESSION["p"]["price"]*$search_data["qty"]?> .00</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="border-0"></td>
                                        <td class="fs-5 text-end fw-bold border-primary">Delivery Fee</td>
                                        <td class="text-end border-primary">Rs. <?php echo $delivery?> .00</td>
                                    </tr><?php $g=$_SESSION["p"]["price"]*$search_data["qty"]+$delivery?>
                                    <tr>
                                        <td colspan="3" class="border-0"></td>
                                        <td class="fs-5 text-end fw-bold border-primary text-primary">GRAND TOTAL</td>
                                        <td class="fs-5 text-end fw-bold border-primary text-primary">Rs.<?php echo $g?> .00</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
