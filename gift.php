...
<head>
    ...
    <title> Gift Items | Gimmick  </title>
...
?>
    ...
    <div class="row" id="basicSearchResult">
     <?php 
       ...
       if(isset($_GET["page"])){
        ...
        $product=Database::search("SELECT * FROM `product` WHERE `status_id`='1'");
        ...
        $selected_rs=Database::search("SELECT * FROM `product` WHERE `status_id`='1' LIMIT " . $results_per_page . " OFFSET " . $page_results . "");
    ...
    <?php
        for($x=0; $x<$selected_num;$x++){
            ...
            <a href='<?php echo "productView.php?pid=".($product_data['id'])?>'> <img src="<?php echo $image_data["path"] ?>" class="card-img-top image1" alt="..." style="height:30vh;width:65% " /></a>
                    <div class="card-body">
                    ...
                    <?php 
                       ...
                       //$check=Database::search("SELECT * FROM `gift_box` WHERE `product_id`='".$product_data["id"]."' AND `user_email`='".$email."'");
                       ...
                       //if($check_num==1){
                        //if(isset($_SESSION["u"]["email"])){
                            $email=$_SESSION["u"]["email"];
                            ?>
                            <button class="col-12 btn btn-light border-dark mt-2 mb-2" disabled>
                            Out Of Stock!</button>
                        ...
                        //}else{
                            ?>
                            <!-- <button class="col-12 btn btn-light border-dark mt-2 mb-2" onclick="addToGiftBox(<?php echo $product_data['id'] ?>);"  disabled>
                            Out Of Stock !</button> -->
                            <?php
                       ...
                       //}else{
                        ?>
                        <!-- <button class="col-12 btn btn-light border-dark mt-2 mb-2" onclick="addToGiftBox(<?php echo $product_data['id'] ?>);" >
                        <i class="bi bi-gift-fill text-dark fs-5 " id="gift<?php echo $product_data["id"]; ?>"></i></button> -->
                        <?php
                      // }
                       ?>
            ...
            <!-- card -->
               ...
               <div class="card mt-3 mb-3 " style="width: 18rem; height:70vh; " >
                   <a href='<?php echo "productView.php?pid=".($product_data['id'])?>'> <img src="<?php echo $image_data["path"] ?>" class="card-img-top image1" alt="..." style="height:30vh; width:70%; margin-top:5vh" /></a>
                       <div class="card-body">
                       <h5 class="card-title"><?php echo $product_data["title"];?></h5>
                       <p class="card-text">
                           <hr/>
                       ...
                       <?php 
                       //$check=Database::search("SELECT * FROM `gift_box` WHERE `product_id`='".$product_data["id"]."'");
                       //$check_data->fetch_assoc();
                       //$check_num=$check->num_rows;
                       //if($check_num==1){
                       // if(isset($_SESSION["u"]["email"])){
