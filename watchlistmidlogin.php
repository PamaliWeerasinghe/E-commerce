                    ...
                    <div class="col-12 col-lg-6 p-3 mt-5 vh-120" id="signInBox" style="margin-top: -6px;" >
                        ...
                        ?>
                            ...
                            <div class="col-6 text-end mt-4">
                                <a href="" class="link-primary " onclick="forgotPasswordInputValidation();">Forgot Password?</a>
                            </div>
                            <div class="col-12 col-lg-6 offset-lg-3 mt-5">
                                <a href="#" class="btn d-grid text-white" style="background-color: rgb(35, 35, 86)" onclick="signIn2();">Sign In</a>
                            </div>
