...
<head>
    ...
    <title>Samsung Products | Gimmick</title>
    ...
    <div class="row">
     <?php 
       ...
       if(isset($_GET["page"])){
        ...
        INNER JOIN `brand` ON `brand_has_model`.`brand_id`=`brand`.`id` WHERE `brand`.`name`='Samsung'");
        ...
        INNER JOIN `brand` ON `brand_has_model`.`brand_id`=`brand`.`id` WHERE `brand`.`name`='Samsung' LIMIT " . $results_per_page . " OFFSET " . $page_results . "");
