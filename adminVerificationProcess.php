...
if(isset($_POST["e"])){
    ...
    if($admin_num > 0){
        ...
        $mail = new PHPMailer;
            ...
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            $mail->setFrom('pamalidevanga2002@gmail.com', 'Admin Verification');
            $mail->addReplyTo('pamalidevanga2002@gmail.com', 'Admin Verification');
            $mail->addAddress($email);
            $mail->isHTML(true);
            $mail->Subject = 'GIMMICK Admin Login Verification Code';
